import type { Page, SubPackage } from '@skiyee/oiyo'

import pagesJson from '~/pages.json'

/** 微信小程序环境判断（避免抖音小程序缺少 process 报错） */
let isMpWeixin = false
// #ifdef MP-WEIXIN
isMpWeixin = true
// #endif

// oiyo 生成的 pages.json 可能没有 subPackages 字段，这里做兜底处理
const pages: Page[] = pagesJson.pages ?? []
const subPackages: SubPackage[] = pagesJson.subPackages ?? []
